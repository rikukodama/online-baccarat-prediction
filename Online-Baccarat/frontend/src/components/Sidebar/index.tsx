...
import AddMember from '../../layout/AddMember';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    {/* <AddChannel modalVisible = {modalVisible} setModalVisible={ setModalVisible } /> */}
    {/* <AddMember memberModalVisible = {memberModalVisible} setMemberModalVisible={ setMemberModalVisible } /> */}
    </>
  );
};
