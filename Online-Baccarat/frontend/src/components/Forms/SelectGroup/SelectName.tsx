...
const SelectName: React.FC = () => {
  ...
  return (
      <div className="relative w-[200px] z-20 bg-transparent dark:bg-form-input">
        ...
        >
          <option value="name1" className="text-body dark:text-bodydark">
          Name1
          </option>
          <option value="name2" className="text-body dark:text-bodydark">
          Name2
          </option>
          <option value="name3" className="text-body dark:text-bodydark">
          Name3
          </option>
        </select>
